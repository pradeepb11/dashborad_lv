...
export declare class TimeSelectComponent implements OnInit, OnChanges, ControlValueAccessor, Validator {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TimeSelectComponent, "dp-time-select", never, { "config": "config"; "displayDate": "displayDate"; "minDate": "minDate"; "maxDate": "maxDate"; "minTime": "minTime"; "maxTime": "maxTime"; "theme": "theme"; }, { "onChange": "onChange"; }, never, never>;
}
